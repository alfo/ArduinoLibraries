...
void menuChanged(MenuChangeEvent changed){
  ...
  OLED.cursorPosition(1,0); //set the start position for lcd printing to the second row
  
  if(newMenuItem.getName()==menu.getRoot()){
      screenPrint("Main Menu       ");
  }else if(newMenuItem.getName()=="Item1"){
      screenPrint("Item1           ");
  }else if(newMenuItem.getName()=="Item1SubItem1"){
      screenPrint("Item1SubItem1");
  }else if(newMenuItem.getName()=="Item1SubItem2"){
      screenPrint("Item1SubItem2   ");
  }else if(newMenuItem.getName()=="Item2"){
      screenPrint("Item2           ");
  }else if(newMenuItem.getName()=="Item2SubItem1"){
      screenPrint("Item2SubItem1   ");
  }else if(newMenuItem.getName()=="Item2SubItem2"){
      screenPrint("Item2SubItem2   ");
  }else if(newMenuItem.getName()=="Item2SubItem3"){
      screenPrint("Item2SubItem3   ");
...
void menuUsed(MenuUseEvent used){
  OLED.cursorPosition(1,0);  
  screenPrint("You used        ");
  OLED.cursorPosition(0,0); 
  screenPrint(used.item.getName());
  OLED.cursorPosition(1,0);
